...
use tts::{EngineFactory, Qwen3Config, TtsConfig, VoicePrompt, VoxCpmConfig};
...
async fn main() -> Result<()> {
    ...
    // ================= Qwen3-TTS ==================
    let qwen_path = dirs::home_dir()
        .unwrap()
        .join(".aha/Qwen/Qwen3-TTS")
        .to_string_lossy()
        .to_string();
